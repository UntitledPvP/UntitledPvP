...
client.on('message', message => {
    if (message.content.startsWith("%new")) {
        ...
        if (message.guild.channels.exists("name", "ticket-" + message.author.name + message.author.discriminator)) return message.channel.send(`You already have a ticket open.`);
